class ContactList {
    ...
    drow() {
        ...
        let contactBox = new contactListHtml(container);
        contactBox.appendToContainer();
    }
...
class contactListHtml {
    #contactBox = `<div class="contact_box">
        ...
        <div class="contact_box_form">
            ...
            <div class="contact_box_form_row">
                ...
                <button class="clear_contact"><img src="images/delete.jpg"></button>
            </div>
        </div>
    ...
    initAddItems() {
        this.#containerForContactBox.querySelector('.add_contact').addEventListener('click', (param) => {
            ...
            console.log(this.#containerForContactBox.querySelector('.contact_box_item_remove'));
        });
    }
